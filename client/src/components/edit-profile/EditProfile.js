...
class EditProfileComponent extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      profile.status = !_.isEmpty(profile.status) ? profile.status : "";
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.handleSubmit}>
                ...
                <TextFieldGroup
                  ...
                  onChange={this.handleFieldChange("githubusername")}
                  error={errors.githubusername}
                  info="Please let us know your Github username."
                />
                <TextFieldGroup
...
export const EditProfile = connect(mapStateToProps, {
  createProfile,
  getCurrentProfile
})(withRouter(EditProfileComponent));
